...
// NOTE: Commented out to avoid circular dependency between utils and history packages
// This function requires HistoryFile from the history package, but history needs utils
/*
